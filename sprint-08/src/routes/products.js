...
router.post('/create', upload.single('img_id'), validationProducts, productsController.create); //validationProducts
...
router.put('/upload/:id',upload.single('img_id'), productsController.update);
